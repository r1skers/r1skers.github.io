...
- `2.5` [Heat Kappa Inverse 参数反演验证 / Heat Kappa Inverse Parameter Inversion](/artifacts/02-forgeflow/2-5-heat-kappa-inverse/)
...
`heat_kappa_inverse` 定位为“观测特征 -> 参数”反演样例（ID/OOD/噪声鲁棒性）。
