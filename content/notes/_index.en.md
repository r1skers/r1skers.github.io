...
- [**Part 0** — Matrix, Linear Map, and Coordinate Language](/en/notes/math/linear-algebra/note-la-0-foundation/) — The series foundation: matrix as the coordinate representation of a linear map
...
- [**Part 1** — From Schrödinger to Wave Functions](/en/notes/science/quantum-mechanics/note-qm-1-schrodinger)
