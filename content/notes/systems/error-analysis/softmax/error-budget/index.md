...
weight: 4
aliases:
  - /notes/systems/error-analysis/softmax/note-error-softmax-4-floating-point-budget/
---
...
但误差界不是每个输入都会达到。若所有 $q_i=1$，FP32 在 $n \lt 2^{24}$ 时可能精确累加这些整数，实验反而看不到误差。更有辨识力的构造是
...
**下一篇：** [Softmax 5：求和顺序怎样吞掉尾部小量](/notes/systems/error-analysis/softmax/summation-stagnation/)
