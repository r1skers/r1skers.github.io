...
**上一篇：** [Softmax 4：把 exp、求和与除法写进误差预算](/notes/systems/error-analysis/softmax/error-budget/)

**下一篇：** [Softmax 6：从观测到 consumer-specific 处置](/notes/systems/error-analysis/softmax/consumer-mitigation/)
