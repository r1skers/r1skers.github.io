...
weight: 1
aliases:
  - /notes/systems/error-analysis/softmax/note-error-softmax-1-directional-jacobian/
---
...
**Next:** [Softmax 2: Directions and Spectrum on the Probability Simplex](/en/notes/systems/error-analysis/softmax/geometry-spectrum/)
