...
summary: "固定 dx / 固定 ratio）。 / Starting from Part 1 spatial discretization, this note builds the time-marching framework and provides CFL-ratio constraints with practical step-size design (fixed dt / fixed dx / fixed ratio)."
