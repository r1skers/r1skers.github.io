...
draft: false
title: '计算科学与高可靠系统设计第1部分：连续到离散的建模基础（离散拉普拉斯与矩阵表示） / Computational Science & High-Reliability Systems Design Part 1: Continuous-to-Discrete Modeling (Discrete Laplacian and Matrix Form)'
summary: "聚焦把连续扩散模型转成机器可计算形式：网格化、五点差分与矩阵化。 / Focus on turning a continuous diffusion model into computable form: gridding, five-point discretization, and matrix assembly."
