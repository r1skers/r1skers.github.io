...
这个区间比纯粹保证收敛所需的 $0<\eta<2/\sigma_1^2$ 更窄；采用它是为了让每个谱方向的因子 $1-\eta\sigma_i^2$ 都落在 $[0,1)$，从而下面的“先后进入”解释保持单调而不发生振荡。
...
因为 $|1-\eta\sigma_i^2|<1$，当 $t\to\infty$ 时，滤子收敛到 $1/\sigma_i$，$x_t$ 收敛到最小范数最小二乘解。
